...
extern LCM_DRIVER ili9806e_fwvga_dsi_vdo_tcl50_lcm_drv;//add by ling.li 2015.3.16
...
#endif
#if defined(ILI9806E_FWVGA_DSI_VDO_TCL50)
    &ili9806e_fwvga_dsi_vdo_tcl50_lcm_drv,
#endif
