...
#if 1  // //ÓÉÓÚORSIE Ìá¹©120604  OTM8018B+4.3HSD   
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//params->dsi.dsi_clock = 204;
	//params->dsi.TA_SACK = 5;
	//params[1].dbi.serial.cs_polarity = 55;
	//params[1].dbi.serial.clk_polarity = 98;
...
LCM_DRIVER TM_otm8012_fwvga_cmd_lcm_drv = 
{

	.name			= "TM_otm8012_fwvga_cmd",
